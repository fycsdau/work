...
<body>
    <header class="page-header">
        ...
        <div class="header-title">提现记录</div>
    </header>
                ...
                <?php if(is_array($record)): $i = 0; $__LIST__ = $record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell">
                        <div class="section-box">
                            <div class="section-box-item">
                                <div class="record-price"><span><?php echo ($v['money']); ?></span> 元</div>
                                <div class="record-bank"><?php echo ($v['bankname']); ?></div>
                            </div>
                            <div class="section-box-item">
                                <div class="record-status 
                                <?php if(($v['status']) == "3"): ?>success<?php endif; ?>
                                "><?php echo ($v['statusname']); ?></div>
                                <div class="record-date"><?php echo ($v['creat_time']); ?></div>
                            </div>
                        </div>
