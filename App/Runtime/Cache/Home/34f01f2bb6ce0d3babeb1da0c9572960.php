<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
  <form id="pagerForm" data-toggle="ajaxsearch" action="/admin.php/Home/Jobtype" method="post">
    ...
    <div class="bjui-searchBar">
     ...
     <div class="pull-right">
         <span <?php echo display(CONTROLLER_NAME.'/add'); ?> >
             <a href="/admin.php/Home/Jobtype/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-green" data-toggle="dialog" data-width="600" data-height="210" data-id="dialog-mask" data-mask="true" data-icon="plus">添加类型</a>
         </span>
     </div>
  </form>
  ...
  <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true" data-toggle="tablefixed">
    <thead>
      <tr>
        ...
        <th align="center" data-order-direction="desc" data-order-field="type_name"> 类别名称</th>
    ...
    <tbody>
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td align="center"> 
            <span>
              <a href="/admin.php/Home/Jobtype/del/id/<?php echo ($v['user_id']); ?>/navTabId/users" class="btn btn-red btn-sm" data-toggle="doajax" data-confirm-msg="确定要删除吗？">删除</a>
            </span> 
          </td>
