...
$sql = "select appid,appsecret,token,url from `llhl_wechat_config` limit 0,1";
$row = \LaneWeChat\Core\DB::get_one($sql);
$appid = $row['appid'];
$appsecret = $row['appsecret'];
$token = $row['token'];
$url = $row['url'];

define("WECHAT_URL", $url);
define('WECHAT_TOKEN', $token);
define('ENCODING_AES_KEY', "aJVQ05H6et88WEtLZvQpOUF8qMfFDoWTCT91LHGXNqI");

/*
 * 开发者配置
*/
define("WECHAT_APPID", $appid);
define("WECHAT_APPSECRET", $appsecret);
