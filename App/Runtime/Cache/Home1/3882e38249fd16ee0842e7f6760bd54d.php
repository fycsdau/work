<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent">
    <form action="/admin.php/Home/User/edit/navTabId/user" class="pageForm" data-toggle="validate">
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="sex"  data-toggle="selectpicker" data-rule="required">
                                <option value="男" <?php if($Rs['sex'] == '男' ): ?>selected<?php endif; ?>>男</option>
                                <option value="女" <?php if($Rs['sex'] == '女' ): ?>selected<?php endif; ?>>女</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="depid" class="control-label x85">系统角色：</label>
                            <select  name="depid" data-toggle="selectpicker" data-rule="required">
                                ...
                                <?php if(is_array($listz)): foreach($listz as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v["id"] == $Rs['depid'] ): ?>selected<?php endif; ?> >
                                        <?php echo ($v["title"]); ?>
