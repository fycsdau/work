...
<body>
    <header class="page-header">
        ...
        <div class="header-title">我的伙伴</div>
    </header>
    <section class="container">
        <section class="friends">
            <ul class="mui-table-view">
                <?php if(($nopartner) == "1"): ?><li style="text-align:center; padding:20px 0px;">您还没有伙伴，<br>快把我们介绍给您的朋友,<br>您会获得奖金哦～</li><?php endif; ?>
                <?php if(is_array($partner)): $i = 0; $__LIST__ = $partner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell">
                        <div class="section-box">
                            <div class="section-box-item">
                                <span class="friends-avatar"><img src="<?php echo ($v['headimgurl']); ?>" alt=""></span>
                                <?php echo ($v['nickname']); ?>
                            </div>
                            <?php if($v['cost_money'] == '0.00' ): ?><i class="user-icon-iconhqb01 ispay"></i>
                                <?php else: ?>
                                <i class="user-icon-iconhqb01 ispay haspay"></i><?php endif; ?>
                        </div>
