...
<body>
    ...
    <section class="container">
        <section class="orders">
            ...
            <?php if(is_array($order)): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="mui-card">
                    <ul class="mui-table-view">
                        <li class="mui-table-view-cell">
                            <div class="section-box orders-item-header">
                                <div class="section-box-item">订单状态：<?php echo ($v['statusname']); ?></div>
                                <div class="section-box-item orders-date"><?php echo ($v['create_time']); ?></div>
                            </div>
                            <a href="/index.php/user/order_detail/id/<?php echo ($v['order_id']); ?>" class="mui-navigate-right">
                                <div class="section-box orders-info">
                                    <div class="orders-logo"><i class="<?php echo ($v['operate_class']); ?>"></i></div>
                                    <div class="section-box-item orders-info-txt">
                                        <div>订单编号：<span><?php echo ($v['order_sn']); ?></span></div>
                                        <div>订单金额：<span><?php echo ($v['order_money']); ?></span></div>
                                        <div>手机号码：<span><?php echo ($v['phone']); ?></span></div>
                                    </div>
                                </div>
                            </a>
                        </li>
