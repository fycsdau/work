...
<body>
    ...
    <section class="container">
        <section>
            <ul class="mui-table-view cards-list">

                <?php if(is_array($bank)): $i = 0; $__LIST__ = $bank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell">
                        <a href="addcard/bank_id/<?php echo ($v['bank_id']); ?>">
