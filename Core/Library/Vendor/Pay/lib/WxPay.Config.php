...
//商户基本信息
defined('APPID') || define('APPID','wx0edb7bf3e998c66d');//APPID
defined('MCHID') || define('MCHID', '1320123301');//商户号
defined('KEY') || define('KEY', '1QAZ2wsx3edc4rfv5tgb6yhn7ujm8ik9');//密钥
defined('APPSECRET') || define('APPSECRET', 'da76b64541cc814c336c678c88c95bb2');//appsecret
